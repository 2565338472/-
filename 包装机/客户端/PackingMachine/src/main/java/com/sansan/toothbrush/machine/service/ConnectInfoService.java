...
public class ConnectInfoService {
	...
	public List<Address> findAll(){
		String sql = "select ci.id id,pd.machine_name name,ci.ip ip,ci.port port from ss_connect_info ci join ss_production_data pd  on ci.id = pd.connect_info_id group by ci.id";
